...
{
		HX_STACK_FRAME("haxe.Http","request",0xb2c949d1,"haxe.Http.request","C:\\HaxeToolkit\\haxe\\std/haxe/Http.hx",197,0xd46eaf46)
		HX_STACK_THIS(this)
		...
		Void run(::String e){
			HX_STACK_FRAME("*","_Function_1_1",0x5200ed37,"*._Function_1_1","C:\\HaxeToolkit\\haxe\\std/haxe/Http.hx",367,0xd46eaf46)
			HX_STACK_ARG(e,"e")
			{
				HX_STACK_LINE(371)
...
{
		HX_STACK_FRAME("haxe.Http","customRequest",0x68e97fa0,"haxe.Http.customRequest","C:\\HaxeToolkit\\haxe\\std/haxe/Http.hx",400,0xd46eaf46)
		HX_STACK_THIS(this)
		HX_STACK_ARG(post,"post")
...
;
		...
		if (((this->postData != null()))){
			...
			if (((bool(post) && bool((uri != null()))))){
				...
				bool run(Dynamic h){
					HX_STACK_FRAME("*","_Function_3_1",0x520271b9,"*._Function_3_1","C:\\HaxeToolkit\\haxe\\std/haxe/Http.hx",502,0xd46eaf46)
					HX_STACK_ARG(h,"h")
					{
						HX_STACK_LINE(502)
...
{
		HX_STACK_FRAME("haxe.Http","readHttpResponse",0x6bff43dd,"haxe.Http.readHttpResponse","C:\\HaxeToolkit\\haxe\\std/haxe/Http.hx",559,0xd46eaf46)
		HX_STACK_THIS(this)
		HX_STACK_ARG(api,"api")
		HX_STACK_ARG(sock,"sock")
		HX_STACK_LINE(561)
...
bool Http_obj::readChunk( ::EReg chunk_re,::haxe::io::Output api,::haxe::io::Bytes buf,int len){
	HX_STACK_FRAME("haxe.Http","readChunk",0xeebfa239,"haxe.Http.readChunk","C:\\HaxeToolkit\\haxe\\std/haxe/Http.hx",699,0xd46eaf46)
	HX_STACK_THIS(this)
...
{
		HX_STACK_FRAME("haxe.Http","onData",0x4f093aa7,"haxe.Http.onData","C:\\HaxeToolkit\\haxe\\std/haxe/Http.hx",765,0xd46eaf46)
		HX_STACK_THIS(this)
...
Void run(::String msg){
{
		HX_STACK_FRAME("haxe.Http","onError",0x77abd4ab,"haxe.Http.onError","C:\\HaxeToolkit\\haxe\\std/haxe/Http.hx",775,0xd46eaf46)
		HX_STACK_THIS(this)
...
Void run(int status){
{
		HX_STACK_FRAME("haxe.Http","onStatus",0xf341a4ef,"haxe.Http.onStatus","C:\\HaxeToolkit\\haxe\\std/haxe/Http.hx",785,0xd46eaf46)
		HX_STACK_THIS(this)
