...
{
		HX_STACK_FRAME("haxe.io.BytesOutput","writeByte",0xed1b0d05,"haxe.io.BytesOutput.writeByte","C:\\HaxeToolkit\\haxe\\std/haxe/io/BytesOutput.hx",52,0xe8d8730b)
		HX_STACK_THIS(this)
		HX_STACK_ARG(c,"c")
		HX_STACK_LINE(52)
		this->b->b->push(c);
...
int BytesOutput_obj::writeBytes( ::haxe::io::Bytes buf,int pos,int len){
	HX_STACK_FRAME("haxe.io.BytesOutput","writeBytes",0x8a9057ce,"haxe.io.BytesOutput.writeBytes","C:\\HaxeToolkit\\haxe\\std/haxe/io/BytesOutput.hx",56,0xe8d8730b)
	HX_STACK_THIS(this)
...
::haxe::io::Bytes BytesOutput_obj::getBytes( ){
	HX_STACK_FRAME("haxe.io.BytesOutput","getBytes",0x9fe35837,"haxe.io.BytesOutput.getBytes","C:\\HaxeToolkit\\haxe\\std/haxe/io/BytesOutput.hx",119,0xe8d8730b)
	HX_STACK_THIS(this)
	HX_STACK_LINE(119)
