...
HX_DEFINE_DYNAMIC_FUNC1(ICoverageTestResultClient_obj,setCurrentTestClassCoverage,)

HX_DEFINE_DYNAMIC_FUNC6(ICoverageTestResultClient_obj,reportFinalCoverage,)
...
Class ICoverageTestResultClient_obj::__mClass;

void ICoverageTestResultClient_obj::__register()
{
	hx::Static(__mClass) = hx::RegisterClass(HX_CSTRING("massive.munit.ICoverageTestResultClient"), hx::TCanCast< ICoverageTestResultClient_obj> ,0,sMemberFields,
	0, 0,
...
void ICoverageTestResultClient_obj::__boot()
{
}
